...
sol_storage! {
    #[entrypoint]
    pub struct StylusTransferableERC20 {
    }
}

#[public]
impl StylusTransferableERC20 {
    #[constructor]
    ...
    pub fn get_module_config(&self) -> Result<ModuleConfig, Vec<u8>> {
        Ok(ModuleConfig {
            ...
            callbackFunctions: vec![
                CallbackFunction {
                    selector: FixedBytes::from(function_selector!("beforeTransferERC20", Address, Address, U256)),
                },
            ],
    ...
    #[selector(name = "beforeTransferERC20")]
    pub fn before_transfer_erc20(
        &mut self,
        from: Address,
        to: Address,
        _amount: U256
